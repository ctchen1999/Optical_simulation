...
% eyebrow
x_eyebrow_left = [-3.4 -2.1 -0.8];
y_eyebrow_left = [2.7 2.8 2.3];
xi_eyebrow = -3.4:0.01:-0.8;
eyebrow_left1 = interp1(x_eyebrow_left, y_eyebrow_left, xi_eyebrow, 'spline');
plot(xi_eyebrow, eyebrow_left1,'k');

x_glasses_right = [3.4 2.1 0.8];
y_glasses_right = [2.7 2.8 2.3];
xi_glasses = 3.4:-0.01:0.8;
glasses_right1 = interp1(x_glasses_right, y_glasses_right, xi_glasses, 'spline');
plot(xi_glasses, glasses_right1,'k');

% ear
polygon_left_ear = polyshape([-4.3 -4.5  -4.7  -4.9  -5.1  -5.3 -5.5  -5.1 -4.5], ...
                             [ 2.6 2.9    3  3.07  3.15  3.07 2.5 0.8  -1]);
plot(polygon_left_ear, 'FaceColor', [0.9764, 0.9529, 0.8784]);
polygon_right_ear = polyshape([4.3   4.5  4.7  4.9   5.1   5.3   5.5  5.1   4.5], ...
                             [ 2.6 2.9    3  3.07  3.15  3.07 2.5 0.8  -1]);
...
nose_left  = plot([-0.4 -0.45 -0.6 -0.7 -0.8 -0.85  -0.9], ...
                  [   1  0.5   0   -1.5   -2  -2.5   -3], 'color',[0 0 0]);
