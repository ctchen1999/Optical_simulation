classdef compound<handle
	...
	methods
        function self = compound(ox,oy,vx,vy,I,varargin)
            persistent id_
            ...
            figure(1),
            patch(self.cx+self.pointX,self.cy+self.pointY,'k')
        ...
        function obj=move(obj,gr,w)
            ...
            %畫圖
            figure(1),
            patch(obj.cx+obj.pointX,obj.cy+obj.pointY,'k');
        end
	end
end